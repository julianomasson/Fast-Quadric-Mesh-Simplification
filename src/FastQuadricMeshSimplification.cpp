...
{	
	...
	void FastQuadricMeshSimplification::simplify_mesh(int target_count, double agressiveness)
	{
		// init
	...
	double FastQuadricMeshSimplification::vertex_error(SymetricMatrix q, double x, double y, double z)
	{
		return   q[0] * x * x + 2 * q[1] * x * y + 2 * q[2] * x * z + 2 * q[3] * x + q[4] * y * y
			+ 2 * q[5] * y * z + 2 * q[6] * y + q[7] * z * z + 2 * q[8] * z + q[9];
	}

	double FastQuadricMeshSimplification::calculate_error(int id_v1, int id_v2, vec3f& p_result)
	{
	...
	bool FastQuadricMeshSimplification::flipped(vec3f p, int i0, int i1, Vertex& v0, Vertex& v1, std::vector<int>& deleted)
	{
		int bordercount = 0;
		loopk(0, v0.tcount)
		{
	...
	void FastQuadricMeshSimplification::update_triangles(int i0, Vertex& v, std::vector<int>& deleted, int& deleted_triangles)
	{
		vec3f p;
		loopk(0, v.tcount)
		{
